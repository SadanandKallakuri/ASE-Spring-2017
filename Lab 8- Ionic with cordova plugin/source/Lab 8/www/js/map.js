  ...
  $scope.mapg=function () {
    ...
    locs.success(function (data) {
      ...
      weather.success(function (data) {
        ...
        var venues = $http.get("https://api.foursquare.com/v2/venues/search/?client_id=NTWXDKJP1JWD5GPDS3QQNDCUVHPSFRO555RUTJLBM5IA1FGL%20&client_secret=IMF0TTYFJLCE3EMZHXPW5FALFVY0HSPTKO5IUXYLIAGLPBSQ&v=20201111%20&m=foursquare&near=" +loc + "&categoryId=4bf58dd8d48988d180941735")
    ...
    navigator.geolocation.getCurrentPosition(function(location) {
      ...
      weather.success(function (data) {
        ...
        locs.success(function (data) {
          ...
          count = value.length;
          city = value[count - 3];
          var venues = $http.get("https://api.foursquare.com/v2/venues/search/?client_id=NTWXDKJP1JWD5GPDS3QQNDCUVHPSFRO555RUTJLBM5IA1FGL%20&client_secret=IMF0TTYFJLCE3EMZHXPW5FALFVY0HSPTKO5IUXYLIAGLPBSQ&v=20201111%20&m=foursquare&near=" + city + "&categoryId=4bf58dd8d48988d180941735")
          venues.success(function (data) {
            for (var i = 0; i < data.response.venues.length; i++) {
              $scope.disp = {
                "Name": data.response.venues[i].name,
